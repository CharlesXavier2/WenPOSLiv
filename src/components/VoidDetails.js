...
// date=2019-05-18&filter_type=week&region_id=1
// http://104.211.49.150:3001/v2/get_void?filter_type=week&date=2019-05-18&region_id=1
const baseUrl = 'http://104.211.49.150:3001/v2/get_void?filter_type=';
// http://192.168.1.11:3001/v2/get_payments_sale?filter_type=year&date=2019-06-03&region_id=1
export default class VoidDetails extends Component {
    ...
    customComponentDidMount = (itemId, parent, isGeo, date, filter_type) => {
        ...
        if ("" + isGeo == "true") {
            ...
            switch (parent) {
                ...
                case '0':
                    ...
                    urlValue = filter_type + '&date=' + urlPanDate + '&am_id=' + itemId;
        ...
        // const urlPan= 'http://192.168.1.11:3001/v2/get_void?filter_type=week&date=2019-05-18&region_id=1'
        ...
        return fetch(urlPan)
            ...
            .then((responseJson) => {
                this.setState({ indeterminate: false });
                console.log(" Body Response void  : " + JSON.stringify(responseJson));
                var netsale = responseJson.sale_info.NetSale;
