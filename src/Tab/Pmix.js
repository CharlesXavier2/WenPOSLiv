...
export default class Pmix extends Component {
    ...
    customComponentDidMount = (itemId, parent, isGeo, date, filter_type) => {
        ...
        baseUrl = 'http://115.112.224.200:3000/v2/get_category_sale?filter_type='
        if ("" + isGeo == "true") {
            ...
            switch (parent) {
                ...
                case '1':
                    ...
                    urlValue = baseUrl + filter_type + '&date=' + urlPanDate + '&sub_region_id=' + itemId
            ...
            switch (parent) {
                ...
                case '0':
                    ...
                    urlValue = baseUrl + filter_type + '&date=' + urlPanDate + '&deputy_id=' + itemId
    ...
    //     console.log(" customComponentDidMount start ")
    //     const urlPan = 'http://bkliveapp.bklive.in:4500/v2/get_category_sale?filter_type=day&date=2018-12-24&region_id=1';
    //     console.log("  url " + urlPan)
    //     return fetch(urlPan)
    //         .then((response) => response.json())
    //         .then((responseJson) => {
                                    ...
                                    <View style={{
                                        ...
                                        <Text style={{
                                        ...
                                        }}>
                                            {
                                                ...
                                                //item.current_sale.toFixed(2)
                                                this.totalSaleFormat(item.NetAmount)
                                            }
                                        </Text>
