...
renderItem = ({ item }) => {
  ...
  componentDidMount() {
    const urlPan = 'http://bkliveapp.bklive.in:3600/v2/get_pan_level_sale?filter_type=year&date=2018-10-13&is_delivery=0'
    fetch(urlPan)
        ...
        const urlResion = 'http://bkliveapp.bklive.in:3600/v2/get_all_region_sale?filter_type=year&date=2018-10-13&is_delivery=0'
        fetch(urlResion)
            .then((response) => response.json())
            .then((responseJson) => {
